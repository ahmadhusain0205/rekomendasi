<div class="container" style="margin-top: 5rem;">
        ...
        <?php
            ...
            foreach($y as $b) :
                ...
                if($this->session->userdata('id') == $b->id_user){ 
                    echo '<div class="col"><h1 class="text-center text-warning" style="margin-top: 5%;">Sampean rung tau ngerating blas!</h1></div>';
                }
            endforeach;
            ...
            foreach($z as $p):
                ...
                if($this->session->userdata('id') == $p->id_user){
                    echo '<div class="col"><h1 class="text-center text-warning" style="margin-top: 5%;">Ra ono rekomendasi</h1></div>';
                }
            endforeach;
    ...
    <div class="row justify-content-center pl-0 mt-5">
        ...
        foreach($hasil as $k) : ?>
            ...
            foreach($z as $p):
            if ($this->session->userdata('id') == $p->id_user) {
            echo '<div class="col"><h1 class="text-center text-warning" style="margin-top: 5%;">Kabeh wes sampean jelajahi</h1></div>';
            } endforeach;
            foreach($y as $b) :
            if($this->session->userdata('id') == $b->id_user) { 
                foreach($hasil as $k) : ?>
