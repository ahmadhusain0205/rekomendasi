<div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body shadow">
                <h4 class="font-weight-bold text-warning">ADMIN
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control form-control" name="password" id="password" required value="<?= $a->password; ?>">
                                    </div>
                                    <div class="form-group">
...
<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form method="POST" class="user" action="<?= base_url('Admin/add'); ?>">
                <div class="modal-body">
                    <div class="row">
                        <div class="col">
