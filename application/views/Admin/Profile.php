<div class="container">
    ...
    <div class="row">
        <div class="col">
            <div class="mt-0">
                <a type="button" class="btn btn-warning text-dark float-right" href="<?= base_url('Admin/edit_profile');?>"><i class="fas fa-edit"></i>  Ubah profil</a>
            </div>
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="col text-center">
            <img src="<?= base_url('assets/img/profile/') . $user['image']; ?>" width="100" style="border-radius: 200px;">
        </div>
    </div>
    <br>
    <br>
    <div class="row">
        <div class="col">
            <div class="form-group">
                <label for="full_name" class="col-sm-8 col-form-label">Jeneng lengkap</label>
                <div class="col-sm">
        ...
        <div class="col">
            <div class="form-group">
                <label for="address" class="col-sm-8 col-form-label">Alamat</label>
                <div class="col-sm">
    ...
    <div class="row">
        <div class="col">
            <div class="form-group">
                <label for="phone_number" class="col-sm-8 col-form-label">Nomor hp</label>
                <div class="col-sm">
        ...
        <div class="col">
            <div class="form-group">
                <label for="gender" class="col-sm-8 col-form-label">Jenis Kelamin</label>
                <div class="col-sm">
        ...
        <div class="col">
            <div class="form-group">
                <label for="religion" class="col-sm-8 col-form-label">Agomo</label>
                <div class="col-sm">
